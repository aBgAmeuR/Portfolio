...
export default class Aboutme extends Component {
  ...
  private getIconCode = (iconName: string): ReactElement => {
    ...
    return (
      <main id='aboutme'>
        ...
        <div className='content'>
          ...
          <h2>Compétences 💻</h2>
          <ul>
            <li>• {this.getIconCode("react")}<p>ReactJs: Création d'interfaces utilisateur</p></li>
            <li>• {this.getIconCode("nodejs")}<p>NodeJs: Développement de serveurs</p></li>
            <li>• {this.getIconCode("typescript")}<p>TypeScript: Typage statique pour un code plus propre</p></li>
            <li>• {this.getIconCode("java")}<p>Java: Développement d'applications backend et gestion de bases de données</p></li>
          </ul>
